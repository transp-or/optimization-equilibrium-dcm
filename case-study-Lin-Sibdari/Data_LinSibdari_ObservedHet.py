...
def discrete_choice_model(dict):
    ...
    dict['segm1'] = [0.0, 5.0, 4.0]
    dict['segm2'] = [0.0, 8.0, 3.0]
    dict['segm3'] = [0.0, 2.0, 5.0]
    ...
    for i in range(1,3):
        for n in range(1,dict['N']):
            dict['endo_coef'][i,n] = dict['beta']
    dict['exo_utility'][1,0] = 5.0
    dict['exo_utility'][1,1] = 7.0
    dict['exo_utility'][1,2] = 3.0
    dict['exo_utility'][2,0] = 4.0
    dict['exo_utility'][2,1] = 3.0
    dict['exo_utility'][2,2] = 5.0
...
def supply(dict):
    ...
    dict['ub_p'] = np.array([0, 50.0, 50.0]) # upper bound (0, 1, 2)
...
def demand(dict):
    ...
    dict['popN'] = np.array([1/3, 1/3, 1/3])
