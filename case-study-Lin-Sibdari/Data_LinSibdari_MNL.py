...
def discrete_choice_model(dict):
    ...
    dict['endo_coef'] = np.full((3, dict['N']), 0.0)
    dict['exo_utility'] = np.full((3, dict['N']), 0.0)
    dict['endo_coef'][1,0] = dict['beta']
    dict['endo_coef'][2,0] = dict['beta']
...
def supply(dict):
    ...
    dict['ub_p'] = np.array([0, 30.0, 30.0]) # upper bound (0, 1, 2)

    # Initial price
    #dict['price'] = (dict['ub_p'] + dict['lb_p']) / 2.0
    dict['price'] = np.array([0, 23.02, 16.57]) #analytical
    #dict['price'] = np.array([0, 21.77, 17.63]) #eps-equilibrium 1
    #dict['price'] = np.array([0, 21.83, 16.57]) #eps-equilibrium 2
    #dict['price'] = np.array([0, 22.56, 17.94]) #eps-equilibrium 3
    #dict['price'] = np.array([0, 23.38, 17.96]) #eps-equilibrium 4
    #dict['price'] = np.array([0, 21.90, 16.65]) #eps-equilibrium 5
